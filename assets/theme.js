(function (factory) {
  ...
  var Drawer = /*#__PURE__*/function () {
    ...
    _createClass(Drawer, [{
      ...
      value: function open(event) {
        ...
        document.querySelector('#shopify-section-custom-header-2').style.zIndex = ''; // Ugly hack
        // We attach an event to the page overlay to close it

        this.pageOverlayElement.classList.add('is-visible');
        this.pageOverlayElement.addEventListener('click', this._closeListener);
        document.querySelector("body").classList.add('custom-drawer-opened');
        this.isOpen = true;
      ...
      value: function close(event) {
        ...
        document.querySelector("body").classList.remove('custom-drawer-opened');
        this.isOpen = false;
    ...
    _createClass(ProductVariants, [{
      ...
      value: function _updateProductPrices(newVariant, previousVariant) {
        var productMetaPrices = this.element.querySelector('.ProductMeta__PriceList'),
          productMetaPrices2 = this.element.querySelector('.ProductMeta__PriceList.mobile_only'),
          productMetaPrices3 = this.element.querySelector('.second_p.ProductMeta__PriceList'),
        ...
        if (!newVariant) {
          ...
          productMetaPrices2.innerHTML = '';
          productMetaPrices3.innerHTML = '';
          

          if (newVariant['compare_at_price'] > newVariant['price']) {
            productMetaPrices.innerHTML += "<span class=\"now_text\">now</span><span class=\"ProductMeta__Price Price Price--highlight Text--subdued u-h4\" data-money-convertible>".concat(Currency.formatMoney(newVariant['price'], currencyFormat), "</span>");
            productMetaPrices.innerHTML += "<span class=\"was_text\"> was </span><span class=\"ProductMeta__Price Price Price--compareAt Text--subdued u-h4\" data-money-convertible>".concat(Currency.formatMoney(newVariant['compare_at_price'], currencyFormat), "</span>");
            productMetaPrices2.innerHTML += "<span class=\"now_text\">now </span><span class=\"ProductMeta__Price Price Price--highlight Text--subdued u-h4\" data-money-convertible>".concat(Currency.formatMoney(newVariant['price'], currencyFormat), "</span>");
            productMetaPrices2.innerHTML += "<span  class=\"was_text\"> was </span><span style=\"margin-left: 0;\" class=\"ProductMeta__Price Price Price--compareAt Text--subdued u-h4\" data-money-convertible>".concat(Currency.formatMoney(newVariant['compare_at_price'], currencyFormat), "</span>");
            productMetaPrices3.innerHTML += "<span class=\"now_text\">now </span><span class=\"ProductMeta__Price Price Price--highlight Text--subdued u-h4\" data-money-convertible>".concat(Currency.formatMoney(newVariant['price'], currencyFormat), "</span>");
            productMetaPrices3.innerHTML += "<span  class=\"was_text\"> was </span><span style=\"margin-left: 0;\" class=\"ProductMeta__Price Price Price--compareAt Text--subdued u-h4\" data-money-convertible>".concat(Currency.formatMoney(newVariant['compare_at_price'], currencyFormat), "</span>");
          ...
          productMetaPrices2.innerHTML += "<span class=\"ProductMeta__Price Price Text--subdued u-h4\" data-money-convertible>".concat(Currency.formatMoney(newVariant['price'], currencyFormat), "</span>");
        productMetaPrices3.innerHTML += "<span class=\"ProductMeta__Price Price Text--subdued u-h4\" data-money-convertible>".concat(Currency.formatMoney(newVariant['price'], currencyFormat), "</span>");
        
          }

          productMetaPrices.style.display = '';
          productMetaPrices2.style.display = '';
           productMetaPrices3.style.display = '';
        }
      }
      /**
            ...
            if (newVariant['available']) {
              ...
              if (undefined === this.options['showPriceInButton'] || this.options['showPriceInButton']) {
                addToCartButton.innerHTML = `
                  <span>Add <span class="length-value"></span> to cart</span>
                  <span class="Button__SeparatorDot"></span>
                  <span data-money-convertible>${Currency.formatMoney(newVariant['price'], window.theme.moneyFormat)}</span>
                `;
              } else {
                addToCartButton.innerHTML = `<span>Add <span class="length-value"></span> to cart</span>`;
              }
            } else {
              addToCartButton.setAttribute('disabled', 'disabled');
              addToCartButton.classList.add('Button--secondary');
  ...
  var SearchBar = /*#__PURE__*/function () {
    ...
    _createClass(SearchBar, [{
      ...
      value: function _openSearch() {
        ...
        this.isOpen = true;
        this.pageOverlayElement.classList.add('is-visible');
        document.querySelector('#shopify-section-custom-header-2').style.zIndex = 10;
      }
      /**
      ...
      value: function _closeSearch() {
        ...
        var onTransitionEnd = function onTransitionEnd(event) {
          if (event.propertyName === 'visibility') {
            document.querySelector('#shopify-section-custom-header-2').style.zIndex = '';
    ...
    _createClass(ShopTheLookSection, [{
      ...
      value: function _openPocketZoom(popover) {
        ...
        fastdom.mutate(function () {
          ...
          document.getElementById('shopify-section-custom-header-2').style.cssText = 'transform: translateY(-100%); transition: transform 0.3s ease-in-out;';
      ...
      value: function _closePocketZoom() {
        ...
        fastdom.mutate(function () {
          document.getElementById('shopify-section-custom-header-2').style.cssText = 'transform: translateY(0); transition: transform 0.3s ease-in-out 0.3s;';
  ...
  (function () {
    ...
    (function () {
      var windowWidth = window.innerWidth,
          headerSection = document.getElementById('shopify-section-custom-header-2');
      window.addEventListener('resize', function () {
        var newWidth = -1;
        fastdom.measure(function () {
...
const modalPlusIcons = document.querySelectorAll('.modal-plus-icon');
const modalCloseButtons = document.querySelectorAll('.modal-close-button');

function openModalBox(event) {
  const modalBox = event.target.closest('.modal-box-item').querySelector('.modal-box');
...
function closeModalBox(event) {
  ...
  modalBox.style.transform = 'translate(-50%, 100%)'; 
  setTimeout(() => {
...
modalPlusIcons.forEach((icon) => {
  icon.addEventListener('click', openModalBox);
});

modalCloseButtons.forEach((button) => {
  button.addEventListener('click', closeModalBox);
});
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const closeIcon = document.querySelector(".custom-header-close");
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const megaMenus = document.querySelectorAll(".mega-menu-mobile");

    function toggleTab(tabName) {
        megaMenuTabs.forEach(tab => tab.classList.remove("active"));
        megaMenus.forEach(menu => menu.style.display = "none");

        const tab = document.querySelector(`[data-tab="${tabName}"]`);
        const menu = document.querySelector(`#mega-menu-${tabName}`);
...
document.addEventListener("DOMContentLoaded", function () {
    const accordionHeadings = document.querySelectorAll(".mega-menu-mobile-heading");
...
class customSelect extends HTMLElement{
 constructor() {
   ...
   if(this.initOption) this.initOption.addEventListener('click', this.manageVisibility.bind(this));
   this.addEventListener('click', (event) => {
     event.stopPropagation();
     if (this.selectContainer?.closest('custom-select').querySelector('[data-custom-select-label]')?.classList.contains('active')) {
       this.selectContainer?.closest('custom-select')?.querySelector('[data-custom-select-label]')?.classList.remove('active')
     }else{
       this.selectContainer?.closest('custom-select')?.querySelector('[data-custom-select-label]')?.classList.add('active')
     }
   });


   document.body.addEventListener('click', ()=> {
     let vehicleEle = this.selectContainer.closest('[data-vehicle_box]');
     vehicleEle ? vehicleEle.classList.remove('open') : '' ; 
     
     if (this.selectContainer?.closest('custom-select').querySelector('[data-custom-select-label]')?.classList.contains('active')) {
       this.selectContainer?.closest('custom-select').querySelector('[data-custom-select-label]')?.classList.remove('active');
     } 
     if(this.selectContainer.closest('.sortby-dropdown'))
     this.selectContainer.closest('.sortby-dropdown')?.classList.remove('opened-dropdown');

     this.toggleElement(this.selectContainer, 'close');
 
   });
    window.addEventListener('scroll', (event) => {
    if(window.pageYOffset > 40 ){
      let vehicleEle = this.selectContainer.closest('.topbar [data-vehicle_box]');
      vehicleEle ? vehicleEle.classList.remove('open') : '' ; 
   ...
   */
   toggleElement(container, activity) {
    ...
    if(container.closest('custom-select'))
    activity == 'open' ? container.closest('custom-select').classList.add('open') : container.closest('custom-select').classList.remove('open')

    let contentBlockHeight = this._getHeightofHiddenEle(contentBlock);
    if(activity == 'open'){
 ...
 toggleOptions(event){
  ...
  if(this.initOption.querySelector('.option_txt')){
    let isAccessories = document.querySelector('body').classList.contains('template-collection')
   
    if(isAccessories){
      this.initOption.querySelectorAll('.option_txt').forEach((option)=>{
        option.innerHTML = _this.querySelector('.option_txt').innerHTML;
      });
    } else {
 ...
 manageVisibility(event){
   ...
   if(vehicleEle)
   isOpen ? vehicleEle.classList.remove('open') : vehicleEle.classList.add('open');

   isOpen ? this.toggleElement(this.selectContainer, 'close') : this.toggleElement(this.selectContainer, 'open');
